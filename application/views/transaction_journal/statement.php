							...
							<tbody>
								<?php
									if(($transaction_journal))
									{
										...
										{
											$i++;
											$amount=$transaction_journal_item["amount"];
								?>
											<tr class="gradeX">
												...
												<td class="right" style="vertical-align:middle; width: 100px">
													<?php 
														if($amount>=0)
														{
															echo "<font color='blue'>".number_format($amount,2)."</font>";
															$total_amt_in=$total_amt_in+$amount;
														}
														else
														{
															echo "<font color='blue'>".number_format(0,2)."</font>";
														}
													?>
												</td>
												<td class="right" style="vertical-align:middle; width: 100px">
													<?php 
														if($amount<0)
														{
															$total_amt_out=$total_amt_out+$amount;
															echo "<font color='red'>".number_format($amount,2)."</font>";
														}
														else
														{
															echo "<font color='red'>".number_format(0,2)."</font>";
														}
													?>
												</td>
												<td style="vertical-align:middle">
								...
								?>
										...
										<tr class="gradeX">
											<td colspan='9' style="vertical-align:middle" class="right">
												<b>Total&nbsp;&nbsp;&nbsp;&nbsp;</b>
											</td>
											<td style="vertical-align:middle" class="right">
												<b>
													<?php
														...
														{
															echo "<font color='blue'>".number_format($total_amt_in,2)."</font>";
														}
													?>
												</b>
											</td>
											<td style="vertical-align:middle" class="right">
												<b>
													<?php
														if($total_amt_out<0)
														{
															echo "<font color='red'>".number_format($total_amt_out,2)."</font>";
														}
														else
														{
															echo "<font color='blue'>".number_format(0,2)."</font>";
										...
										<tr class="gradeX">
											...
											<td  colspan='2' style="vertical-align:middle" class="right">
												<b>
													<?php
														$total_amt_all=$total_amt_in+$total_amt_out;
														if($total_amt_all<0)
														{
															echo "<font color='red'>".number_format($total_amt_all,2)."</font>";
														}
														else
														{
															echo "<font color='blue'>".number_format($total_amt_all,2)."</font>";
														}
													?>
												</b>
											</td>
								...
								?>
										<tr class="gradeX">
											<td colspan='13' style="vertical-align:middle">
