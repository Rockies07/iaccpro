...
<link href="<?php echo base_url();?>public/assets/admin/layout3/css/layout.css" rel="stylesheet" type="text/css">
<link href="<?php echo base_url();?>public/assets/admin/layout3/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color">
<link href="<?php echo base_url();?>public/assets/admin/layout3/css/custom.css" rel="stylesheet" type="text/css">
...
<div class="page-header">
	...
	<div class="page-header-top">
		<div class="container-fluid">
			<!-- BEGIN LOGO -->
			<div class="page-logo">
				<!-- <a href="index.html"><img src="<?php echo base_url();?>public/assets/admin/layout3/img/logo-default.png" alt="logo" class="logo-default"></a> -->
			</div>
			<!-- END LOGO -->
			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user dropdown-dark">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						<img alt="" class="img-circle" src="<?php echo base_url();?>public/assets/admin/layout3/img/avatar9.jpg">
